...
5. **Real-Time Intra-Batch Deduplication (3-Layer Bulletproof Strategy)** — In-memory deduplication sets (`existing_urls`, `existing_texts`, `existing_event_keys`, `existing_code_keys`) update immediately upon each event insertion:
