...
| --- | --- | --- | --- |
| Events Pipeline | `events_pipeline.yml` | 6:00 AM and 3:00 PM PHT daily (batched A/B then C/D) | Scrapes Facebook pages for LRT-2 disruption events. Supports manual dispatch with batch selection. |
