...
Categories:
1. "academic" - Event related to class suspensions, resumptions, schedule changes, school holidays, or campus-specific events.
...
3. "academic_calendar" - A post explicitly announcing or sharing the full Academic Calendar or School Calendar for the year 2026-2027.
...
Extraction Rules:
- If category is "academic" or "lgu", extract the `event_name` (e.g., "Class Suspension due to Typhoon", "City Anniversary") and `event_date` (e.g., "2026-06-25" or "June 25-26, 2026").
